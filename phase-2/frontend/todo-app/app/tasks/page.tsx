...
import { Plus, ListTodo, SlidersHorizontal, TrendingUp, ArrowLeft, Filter } from 'lucide-react';
        ...
        >
          <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-4">
            <div className="p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl shadow-[0_0_20px_rgba(139,92,246,0.3)]">
              <ListTodo className="h-8 w-8 text-primary-400 drop-shadow-[0_0_8px_rgba(168,85,247,0.5)]" />
            </div>
            <div>
              <h1
